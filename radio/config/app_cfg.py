# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in radio.
...
from radio.lib import app_globals, helpers 

base_config = AppConfig()
base_config.renderers = []
base_config.prefer_toscawidgets2 = True

base_config.package = radio
...
base_config.model = radio.model
base_config.DBSession = radio.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "RockLAB" 
